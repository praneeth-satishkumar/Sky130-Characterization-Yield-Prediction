module characterization_top (busy,
 ...
 sg13g2_buf_1 _2165_ (.A(net17),
    ...
    .VDD(VPWR),
    .VSS(VGND));
 sg13g2_tielo characterization_top (.VDD(VPWR),
    .VSS(VGND),
    .L_LO(net));
 sg13g2_tielo characterization_top_209 (.VDD(VPWR),
    .VSS(VGND),
    .L_LO(net209));
