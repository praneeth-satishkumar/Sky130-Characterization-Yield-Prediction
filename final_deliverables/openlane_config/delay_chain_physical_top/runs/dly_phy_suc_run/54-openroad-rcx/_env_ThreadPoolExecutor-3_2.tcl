...
set ::env(RCX_RULESET) /foss/pdks/sky130A/libs.tech/librelane/rules.openrcx.sky130A.max.calibre
set ::env(SAVE_SPEF) /foss/designs/sky130_characterization/openlane/delay_chain_physical_top/runs/RUN_2026-07-07_15-42-53/54-openroad-rcx/max/delay_chain_physical_top.max.spef
