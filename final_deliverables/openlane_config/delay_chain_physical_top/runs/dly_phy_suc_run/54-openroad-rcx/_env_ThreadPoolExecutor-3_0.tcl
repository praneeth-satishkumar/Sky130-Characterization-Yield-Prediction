...
set ::env(RCX_RULESETS) "\"nom_*\" /foss/pdks/sky130A/libs.tech/librelane/rules.openrcx.sky130A.nom.calibre \"min_*\" /foss/pdks/sky130A/libs.tech/librelane/rules.openrcx.sky130A.min.calibre \"max_*\" /foss/pdks/sky130A/libs.tech/librelane/rules.openrcx.sky130A.max.calibre"
set ::env(CURRENT_DEF) /foss/designs/sky130_characterization/openlane/delay_chain_physical_top/runs/RUN_2026-07-07_15-42-53/53-odb-cellfrequencytables/delay_chain_physical_top.def
set ::env(RCX_LEF) /foss/pdks/sky130A/libs.ref/sky130_fd_sc_hd/techlef/sky130_fd_sc_hd__nom.tlef
set ::env(RCX_RULESET) /foss/pdks/sky130A/libs.tech/librelane/rules.openrcx.sky130A.nom.calibre
set ::env(SAVE_SPEF) /foss/designs/sky130_characterization/openlane/delay_chain_physical_top/runs/RUN_2026-07-07_15-42-53/54-openroad-rcx/nom/delay_chain_physical_top.nom.spef
